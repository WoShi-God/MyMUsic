import { createCipheriv, publicEncrypt, constants, randomBytes, createHash, createDecipheriv } from 'crypto'
...
const rsaEncrypt = (buffer, key) => {
  ...
  return publicEncrypt(
    { key: key, padding: constants.RSA_NO_PADDING },
    buffer,
  )
}
...
const decrypt = (cipherBuffer) => {
  const decipher = createDecipheriv('aes-128-ecb', eapiKey, '')
